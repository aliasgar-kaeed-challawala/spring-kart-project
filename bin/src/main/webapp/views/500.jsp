...
<div class="container text-center my-5">    
    <h1 class="text-primary"><img src="https://img.icons8.com/cute-clipart/100/000000/bug.png"/>500</h1>
    <h1 class="text-primary">Something went wrong...</h1>
    <h5>Something unexpected has occured....</h5>
    <a class="btn btn-outline-secondary" href="/">Take Me Home</a>
</div>
